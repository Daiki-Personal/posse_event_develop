...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/css/review_admin.css')}}">
</head>
...
<body>
    <header class="h-16 bg-white">
        <div class="flex justify-between  items-center w-full h-full mx-auto pl-2 pr-5 pb-5">
            <!-- ナビゲーションバー -->
            <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow-md">
                <div class="h-full">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item mb-3 ml-2">
                            <a href="{{route('list_event')}}" class="nav-link text-white bg-blue-400 px-4 py-2 rounded-3xl bg-gradient-to-r from-blue-600 to-blue-200">管理者画面</a>
                        </li>
                        <li class="nav-item mb-3 ml-2">
